...
public class Component_Status  extends baseTest{
...
public void setUp()
{
	...
	@Test
	public void ComponentStatus() throws InterruptedException {
		
		
		test= extent.createTest("Component_status_overview_Page");
		
		test.info("Component_status_overview");
	...
	//	WebDriver  driver=new ChromeDriver();
	  ...
	  //span[normalize-space()='Component Status']
	    
	    Thread.sleep(2000);
	    WebElement element3 = driver.findElement(By.xpath("//span[normalize-space()='Component Status']"));
	    ...
	    driver.findElement(By.xpath("//input[@id='name']")).sendKeys("sq_Meters");
