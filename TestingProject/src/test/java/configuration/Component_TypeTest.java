...
public class Component_TypeTest extends baseTest{
...
public void setUp()
{
	...
	@Test
	public void componentType() throws InterruptedException {
		
		
		test= extent.createTest("Component_Type_overview_Page");
		
		test.info("Component_Type_overview");
	...
	//	WebDriver  driver=new ChromeDriver();
		...
		test.info("Validation component_Test_type");
	    ...
	    Thread.sleep(2000);
	    WebElement element3 = driver.findElement(By.xpath("//span[normalize-space()='Component Types']"));
	    ...
	    test.info("Component test type form validation");
