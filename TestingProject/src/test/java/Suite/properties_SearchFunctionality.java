...
public class properties_SearchFunctionality extends baseTest  {
	...
	public void testeasy_blockSearch_tab() throws InterruptedException {
		test=extent.createTest("Properties-Global search Functionality","This is to Validate search functionlaity in the list");
